...
def insert_frame( x, y, scale , title ):
    ...
    draw_Text(doc, x + 5000 * scale, y + 200 * scale  , 50*scale , f"현장명 : {title}" , '0')
...
def main():   
    ...
    for file_path in xlsx_files:
        ...
        # y8 = y7 
        # x9 = x8
        # y9 = y8 + wing1 - thickness
        # x10 = x9 +wing2 - thickness*2
        # y10 = y9
        # x11 = x10
        # y11 = y10 - length + thickness*2
        # x12 = x11 - wing2 + thickness*2
        # y12 = y11
        ...
        # d(doc, x2,y2,x3,y3, 200, direction="left")
        # d(doc, x3,y3,x4,y4, 200, direction="down")
        # d(doc, x4,y4,x5,y5, 200, direction="right")
        # d(doc, x5,y5,x6,y6, 200, direction="up")
        # d(doc, x6,y6,x7,y7, 200, direction="left")

        # draw_circle(doc,x4,y4,5)
        ...
        # line(doc, prev_x, prev_y, x1, y1, layer="0")     
        # d(doc, x2,y2,x3,y3, 50, direction="right")
        # d(doc, x3,y3,x4,y4, 50, direction="up")
        # d(doc, x4,y4,x5,y5, 50, direction="left")
        # d(doc, x5,y5,x6,y6, 50, direction="down")
        # d(doc, x6,y6,x7,y7, 50, direction="right")
        ...
        for i in range(repeat+1):
            ...
            line(doc, prev_x, prev_y, x1, y1, layer="0")    
            d(doc, x1,y1,x11,y11, 150, direction="down")
            d(doc, x1,y1,x2,y2, 150, direction="down")
            d(doc, x2,y2,x4,y4, 150, direction="down")
            d(doc, x4,y4,x2,y2, 50, direction="right")
            d(doc, x4,y4,x5,y5, 50, direction="right")
            d(doc, x5,y5,x7,y7, 50, direction="right")
            d(doc, x7,y7,x5,y5, 150, direction="up")
            d(doc, x7,y7,x8,y8, 150, direction="up")
            d(doc, x8,y8,x10,y10, 150, direction="up")
            d(doc, x8,y8,x10,y10, 50, direction="left")
            d(doc, x10,y10,x11,y11, 50, direction="left")
            d(doc, x1,y1,x11,y11, 50, direction="left")
            ...
            for i in range(13, lastNum + 1):
                ...
                line(doc, prev_x, prev_y, curr_x, curr_y, layer="22")

                prev_x, prev_y = curr_x, curr_y

            line(doc, prev_x, prev_y, x13, y13, layer="22")    

            insert_block(doc,x1+22.5,y1+11.75, "8x16_horizontal", layer='0')
            insert_block(doc,x2-22.5,y2+11.75, "8x16_horizontal", layer='0')
            insert_block(doc,x7-22.5,y7-11.75, "8x16_horizontal", layer='0')
            insert_block(doc,x8+22.5,y7-11.75, "8x16_horizontal", layer='0')
            insert_block(doc,x11+11.75,y11+21, "8x16_vertical", layer='0')
            insert_block(doc,x4-11.75,y4+21, "8x16_vertical", layer='0')
            insert_block(doc,x5-11.75,y5-21, "8x16_vertical", layer='0')
            insert_block(doc,x10+11.75,y10-21, "8x16_vertical", layer='0')


            dim_leader(doc, x6 , y6-360 , x6 -170 , y6-100, "V-CUT", direction="rightToleft")
            ...
            line(doc, prev_x, prev_y, x1, y1, layer="0")     
            d(doc, x2,y2,x3,y3, 50, direction="left")
            d(doc, x3,y3,x4,y4, 50, direction="down")
            d(doc, x4,y4,x5,y5, 50, direction="right")

            
            draw_circle(doc,x3,y3,15)
            draw_circle(doc,x4,y4,15)
            ...
            d(doc, x2,y2,x3,y3, 50, direction="up")
            d(doc, x3,y3,x4,y4, 50, direction="left")
            d(doc, x4,y4,x5,y5, 50, direction="down")
            ...
            rectangle(doc, startx,starty, startx+height,starty+77)

            
            line(doc, startx,starty+38.5, startx+720,starty+38.5, layer="22")     
            d(doc, startx,starty+77,startx+720,starty+77, 110, direction="up")
            d(doc, startx+720,starty+38.5,startx+720,starty, 100, direction="right")
            d(doc, startx+720,starty+38.5,startx+720,starty+77, 100, direction="right")
            d(doc, startx+720,starty,startx+720,starty+77, 180, direction="right")
            ...
            for index, g in enumerate(hole):
                ...
                if g is not None : 
                    ...
                    insert_block(doc,startx+g, starty+19.25, "8x16_horizontal")
                    insert_block(doc,startx+g, starty+57.75, "8x16_horizontal")
            ...
            draw_Text(doc, startx+1700, starty+900, 100, "연구소 테이블", layer="0")
            ...
            insert_frame( x1-1770, y1-1520,  frame_scale, "연습도면" )
