...
def MainCeiling():   
    ...
    if program:                
        ...
        #비상구 적용
        if emergencytype == "있음":
            rectangle(doc, x1 + MCW/2 - emergencyRow/2, y2 - 150 - emergencyCol, x1 + MCW/2 + emergencyRow/2, y2 - 150, layer='6')
            rectangle(doc, x1 + MCW/2 - emergencyRow/2 - 10, y2 - 150 - emergencyCol - 10, x1 + MCW/2 + emergencyRow/2 + 10, y2 - 150 + 10, layer='0')
            line(doc, x1 + MCW/2 - emergencyRow/2, y2 - 150 - emergencyCol, x1 + MCW/2 + emergencyRow/2, y2 - 150, layer='0중심')
        else:
            #좌 세로 브라켓
