...
def MainCeiling():   
    ...
    if program:                
        ...
        if lctype == "035":
            ...
            dimcontinue(doc, x2, y2)
            dim(doc, x1 + 155, y1 + 60, x1, y1, 190, direction="down", option='reverse', localdimstyle="0.2 JKW")    
            ...
            dimcontinue(doc, x2, y2)
            dim(doc, x1 + 162, y1 + 60, x1, y1, 190, direction="down", option='reverse', localdimstyle="0.2 JKW")    
        ...
        if emergencytype == "있음":
            ...
            dim(doc, x1 + MCW/2, y2, x1 + MCW/2, y2 - 150, 150, direction="right", localdimstyle="0.2 JKW")
            ...
            if CW<1700:
                #좌 세로 브라켓
                rectangle(doc, EXITx1 - 144, y1 + ELYpos + 66, EXITx1 - 44, y2 - 30.5, layer='2')
                rectangle(doc, EXITx1 - 144 + 18, y1 + ELYpos + 66, EXITx1 - 44 - 18, y2 - 30.5, layer='2')
                rectangle(doc, EXITx1 - 144 + 16, y1 + ELYpos + 66, EXITx1 - 44 - 16, y2 - 30.5, layer='2')
                insert_block(EXITx1 - 94, y1 + ELYpos + 96, "Ceiling_Bracket_vertical_hole2_100")
                insert_block(EXITx1 - 94, y2 - 60.5, "Ceiling_Bracket_vertical_hole2_100")
                insert_block(EXITx1 - 94, y1 + ELYpos + 66 + (MCD - (ELYpos + 96.5))/3, "Ceiling_Bracket_vertical_hole4_100")
                insert_block(EXITx1 - 94, y1 + ELYpos + 66 + (MCD - (ELYpos + 96.5))*2/3, "Ceiling_Bracket_vertical_hole4_100")

                #우 세로 브라켓
                rectangle(doc, EXITx2 + 144, y1 + ELYpos + 66, EXITx2 + 44, y2 - 30.5, layer='2')
                rectangle(doc, EXITx2 + 144 - 18, y1 + ELYpos + 66, EXITx2 + 44 + 18, y2 - 30.5, layer='2')
                rectangle(doc, EXITx2 + 144 - 16, y1 + ELYpos + 66, EXITx2 + 44 + 16, y2 - 30.5, layer='2')
                insert_block(EXITx2 + 94, y1 + ELYpos + 96, "Ceiling_Bracket_vertical_hole2_100")
                insert_block(EXITx2 + 94, y2 - 60.5, "Ceiling_Bracket_vertical_hole2_100")
                ...
                #좌 세로 브라켓
                rectangle(doc, EXITx1 - 174, y1 + ELYpos + 66, EXITx1 - 44, y2 - 30.5, layer='2')
                rectangle(doc, EXITx1 - 174 + 18, y1 + ELYpos + 66, EXITx1 - 44 - 18, y2 - 30.5, layer='2')
                rectangle(doc, EXITx1 - 174 + 16, y1 + ELYpos + 66, EXITx1 - 44 - 16, y2 - 30.5, layer='2')
                insert_block(EXITx1 - 109, y1 + ELYpos + 96, "Ceiling_Bracket_vertical_hole2")
                insert_block(EXITx1 - 109, y2 - 60.5, "Ceiling_Bracket_vertical_hole2")
                insert_block(EXITx1 - 109, y1 + ELYpos + 66 + (MCD - (ELYpos + 96.5))/3, "Ceiling_Bracket_vertical_hole4")
                insert_block(EXITx1 - 109, y1 + ELYpos + 66 + (MCD - (ELYpos + 96.5))*2/3, "Ceiling_Bracket_vertical_hole4")

                #우 세로 브라켓
                rectangle(doc, EXITx2 + 174, y1 + ELYpos + 66, EXITx2 + 44, y2 - 30.5, layer='2')
                rectangle(doc, EXITx2 + 174 - 18, y1 + ELYpos + 66, EXITx2 + 44 + 18, y2 - 30.5, layer='2')
                rectangle(doc, EXITx2 + 174 - 16, y1 + ELYpos + 66, EXITx2 + 44 + 16, y2 - 30.5, layer='2')
                insert_block(EXITx2 + 109, y1 + ELYpos + 96, "Ceiling_Bracket_vertical_hole2")
                insert_block(EXITx2 + 109, y2 - 60.5, "Ceiling_Bracket_vertical_hole2")
    ...
    if program:
        ...
        BasicXscale = 2813
        BasicYscale = 1765
        TargetXscale = BasicXscale + (max(CW, CD) - 1400) 
        TargetYscale = BasicYscale
        if(TargetXscale/BasicXscale > TargetYscale/BasicYscale):
            frame_scale = TargetXscale/BasicXscale
        else:
    ...
    if program:         
        ...
        BasicXscale = 2813
        BasicYscale = 1765
        TargetXscale = BasicXscale + CD - 2000
        TargetYscale = 1665 
        if(TargetXscale/BasicXscale > TargetYscale/BasicYscale):
            frame_scale = TargetXscale/BasicXscale
        else:
    ...
    ###################################################
        ...
        if emergencytype == "있음" and CW < 1700:
            ...
            insert_block(x1 + (MCD - (ELYpos + 96.5))/3, y1 + 75.6, "Ceiling_Bracket_horizontal_hole4_laser_100")
            insert_block(x1 + (MCD - (ELYpos + 96.5))*2/3, y1 + 75.6, "Ceiling_Bracket_horizontal_hole4_laser_100")
...
def main():
    ...
    global headertype, emergencytype, emergencyCol, emergencyRow
