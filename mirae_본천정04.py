...
def lc008_A():   
    ...
    # }        
        ...
        for i, x in enumerate(Bottomx[:-1]):       
            circle_cross(doc, temp_x + x-38.4 + CW/2-75, temp_y + 10, 9, layer='레이져')    
            # print(f"x{i} : {x}")
            if i == 0:
                dim(doc, x1+x-38.4 + CW/2-75 , y1 , x1+x-38.4 + CW/2-75-26, y1 , 100,  direction="down", option='reverse', localdimstyle="0.2 JKW")    
            else:
                dimcontinue(doc , x1 + x-38.4 + CW/2-75, y1)
        dimcontinue(doc ,x2, y2 )

        # 상부 전체치수
        dim(doc, x6+(CW-226.8)/2, y6-15, x6, y6, 100, direction="up", option='reverse', localdimstyle="0.2 JKW")
        dimcontinue(doc, x5, y5)
        ...
        dim(doc, x6 + (CW-226.8)/2, y6 , x6 + (CW-226.8)/2 , y6-15, 100, direction="left", localdimstyle="0.2 JKW")
        ...
        textstr = f"Mat.Spec : EGI 1.6t"    
        draw_Text(doc, x1 , y1 -60 , 30, str(textstr), layer='0')    
        textstr = f"Size : {CW - 226.8} x 131mm"    
        draw_Text(doc, x1 , y1 - 120 , 30, str(textstr), layer='0')        
        textstr = f"Quantity : {su*2} EA"    
        draw_Text(doc, x1 , y1 - 180 , 30, str(textstr), layer='0')    
    ...
    if program:         
        ...
        #절곡 치수선
        dim(doc, x24, y24, x1, y1, 70, direction="right", option="reverse")
        dimcontinue(doc, x23, y23)
        dimcontinue(doc, x14, y14)
        dimcontinue(doc, x13, y13)
        
        dim(doc, x19, y19, x18, y18, 80, direction="up", option="reverse")
    ...
    if program:         
        ...
        #절곡 치수선
        dim(doc, x24, y24, x1, y1, 70, direction="left", option="reverse")
...
def MainCeiling():   
    ...
    if program:
        ...
        def common_cal(CD, CW, ceilingdivision, ELYpos, Side_Gap):
            SplitYpos1 = 0
            SplitYpos2 = 0
            if CD <= 1200:
                SplitYpos1 = CD
            elif 1200 < CD <= 1400 and ceilingdivision == 2:
                SplitYpos1 = math.floor((CD - 500) / 100) * 100
                if SplitYpos1 > 1100:
                    SplitYpos1 = 1100
                SplitYpos2 = CD - SplitYpos1
                ...
                SplitYpos1 = 1000
                SplitYpos2 = math.floor((CD - 1000 - 500) / 100) * 100
                SplitYpos3 = CD - SplitYpos1 - SplitYpos2

            MDFirstSpace = math.floor(CD - ELYpos - 130)
            ...
            return SplitYpos1, SplitYpos2, SplitYpos3, MDFirstSpace, WGap
        
        SplitYpos1, SplitYpos2, SplitYpos3, MDFirstSpace, WGap = common_cal(CD, CW, ceilingdivision, ELYpos, sidePanel)
        ...
        x2 = abs_x + MCW
        y2 = abs_y + MCD
        rectangle(doc, x1, y1, x2, y1 + (MCD - SplitYpos2), layer='0')    
        rectangle(doc, x1, y1 + (MCD - SplitYpos2), x2, y2, layer='0')    
        ...
        #LC 조립홀 가로(header)
        for i, x in enumerate(Bottomx):
            insert_block(x1 + 25 + x, y1 + 87.5, "Ceiling_LChole") 
            if i == 0:
        ...
        #하부 가로 긴 브라켓
        insert_block(x1 + 31, y1 + 252.5, "Ceiling_Bracket_horizontal_holeL")
        insert_block(x2 - 31, y1 + 252.5, "Ceiling_Bracket_horizontal_holeR")
        rectangle(doc, x1 + 31, y1 + 299.5, x2 - 31, y1 + 317.5, layer='2')#상
        rectangle(doc, x1 + 31, y1 + 187.5, x2 - 31, y1 + 205.5, layer='2')#하
        line(doc, x1 + 31, y1 + 203.9, x2 - 31, y1 + 203.9, layer="Hidden")
        line(doc, x1 + 31, y1 + 301.1, x2 - 31, y1 + 301.1, layer="Hidden")
        insert_block(x1 + 31 + (CW - 12)/3, y1 + 252.5, "Ceiling_Bracket_horizontal_hole4")
        insert_block(x2 - 31 - (CW - 12)/3, y1 + 252.5, "Ceiling_Bracket_horizontal_hole4")
        #하부 가로 긴 브라켓 길이 저장
        mcsizex1 = x2 - 31 - (x1 + 31)
        
        #좌 세로 브라켓
        rectangle(doc, x1 + (MCW/3 - 130), y1 + 318.5, x1 + MCW/3, y2 - 30.5, layer='2')
        rectangle(doc, x1 + (MCW/3 - 130) + 18, y1 + 318.5, x1 + MCW/3 - 18, y2 - 30.5, layer='2')
        rectangle(doc, x1 + (MCW/3 - 130) + 16, y1 + 318.5, x1 + MCW/3 - 16, y2 - 30.5, layer='Hidden')
        insert_block(x1 + (MCW/3 - 65), y1 + 348.5, "Ceiling_Bracket_vertical_hole2")
        insert_block(x1 + (MCW/3 - 65), y2 - 60.5, "Ceiling_Bracket_vertical_hole2")
        insert_block(x1 + (MCW/3 - 65), y1 + 318.5 + (MCD - 349)/3, "Ceiling_Bracket_vertical_hole4")
        insert_block(x1 + (MCW/3 - 65), y1 + 318.5 + (MCD - 349)*2/3, "Ceiling_Bracket_vertical_hole4")
        insert_block(x2 - 31 - (CD - 12)/3, y1 + 252.5, "Ceiling_Bracket_horizontal_hole4")
        #좌우 세로 긴 브라켓 길이 저장
        mcsizex3 = y2 - 30.5 - (y1 + 318.5)
        #우 세로 브라켓
        rectangle(doc, x1 + MCW*2/3, y1 + 318.5, x1 + (MCW*2/3 + 130), y2 - 30.5, layer='2')
        rectangle(doc, x1 + MCW*2/3 + 18, y1 + 318.5, x1 + (MCW*2/3 + 130) - 18, y2 - 30.5, layer='2')
        rectangle(doc, x1 + MCW*2/3 + 16, y1 + 318.5, x1 + (MCW*2/3 + 130) - 16, y2 - 30.5, layer='Hidden')
        insert_block(x1 + (MCW*2/3 + 65), y1 + 348.5, "Ceiling_Bracket_vertical_hole2")
        insert_block(x1 + (MCW*2/3 + 65), y2 - 60.5, "Ceiling_Bracket_vertical_hole2")
        insert_block(x1 + (MCW*2/3 + 65), y1 + 318.5 + (MCD - 349)/3, "Ceiling_Bracket_vertical_hole4")
        insert_block(x1 + (MCW*2/3 + 65), y1 + 318.5 + (MCD - 349)*2/3, "Ceiling_Bracket_vertical_hole4")
        
        #중간 가로 브라켓 상
        rectangle(doc, x1 + MCW/3 + 0.5, y2 - 427.5, x1 + MCW*2/3 - 0.5, y2 - 427.5 + 130, layer='2')
        rectangle(doc, x1 + MCW/3 + 0.5, y2 - 427.5 + 18, x1 + MCW*2/3 - 0.5, y2 - 427.5 + 130 - 18, layer='2')
        rectangle(doc, x1 + MCW/3 + 0.5, y2 - 427.5 + 16, x1 + MCW*2/3 - 0.5, y2 - 427.5 + 130 - 16, layer='Hidden')
        insert_block(x1 + MCW/3 + 30.5, y2 - 362.5, "Ceiling_Bracket_horizontal_hole2")
        insert_block(x1 + MCW*2/3 - 30.5, y2 - 362.5, "Ceiling_Bracket_horizontal_hole2")
        insert_block(x1 + MCW/2, y2 - 362.5, "Ceiling_Bracket_horizontal_hole4")
        
        #중간 가로 브라켓 하
        rectangle(doc, x1 + MCW/3 + 0.5, y2 - 1000 - 65, x1 + MCW*2/3 - 0.5, y2 - 1000 + 65, layer='2')
        rectangle(doc, x1 + MCW/3 + 0.5, y2 - 1000 - 65 + 18, x1 + MCW*2/3 - 0.5, y2 - 1000 + 65 - 18, layer='2')
        rectangle(doc, x1 + MCW/3 + 0.5, y2 - 1000 - 65 + 16, x1 + MCW*2/3 - 0.5, y2 - 1000 + 65 - 16, layer='Hidden')
        insert_block(x1 + MCW/3 + 30.5, y2 - 1000, "Ceiling_Bracket_horizontal_hole2")
        insert_block(x1 + MCW*2/3 - 30.5, y2 - 1000, "Ceiling_Bracket_horizontal_hole2")
        insert_block(x1 + MCW/2, y2 - 1000, "Ceiling_Bracket_horizontal_hole4")
        
        #좌측 가로 브라켓
        rectangle(doc, x1 + 30.5, y2 - 1000 - 15, x1 + MCW/3 - 130 - 0.5, y2 - 1000 + 15, layer='2')
        line(doc, x1 + 30.5, y2 - 1000 + 13, x1 + MCW/3 - 130 - 0.5, y2 - 1000 + 13, layer="2")
        ...
        #우측 가로 브라켓
        rectangle(doc, x2 - 30.5, y2 - 1000 - 15, x2 - (MCW/3 - 130 - 0.5), y2 - 1000 + 15, layer='2')
        line(doc, x2 - 30.5, y2 - 1000 + 13, x2 - (MCW/3 - 130 - 0.5), y2 - 1000 + 13, layer="2")
        ...
        dim(doc, x1, y2, x1, y2 - 1000, 150, direction="left", localdimstyle="0.2 JKW")#분할치수
        dimcontinue(doc, x1, y1)
        ...
        dim(doc, x1, y1, x1 + 33, y1 + 252.5, 100, direction="left", localdimstyle="0.2 JKW")#헤다
        #하부 치수선
        textstr =  f"AS = {AS_raw}"
        ...
        #내부 치수선
        dim(doc, x1 + 225, y1 + 280, x1, y1 + 225, 100, direction="up", option="reverse", localdimstyle="0.2 JKW")#헤더 위 가로 브라켓
        dimcontinue(doc, x2 - 225, y1 + 280)
        dimcontinue(doc, x2, y1 + 280)
    ...
    if program:
        ...
        insert_block(x1, y1, "Ceiling_Bottom_section")         
    ...
    if program:    
        ...
        line(doc, x1, y2 - 1000, x2, y2 - 1000, layer="레이져")
        ...
        for i, x in enumerate(Bottomx):
            insert_block(x1 + 25 + x, y1 + 65, "Ceiling_LChole_laser") 
            if i == 0:
        ...
        circle_cross(doc, x1 + 225, y1 + 252.5, 20, layer='레이져')
        circle_cross(doc, x2 - 225, y1 + 252.5, 20, layer='레이져')
        circle_cross(doc, x1 + 40, y1 + 252.5, 8, layer='레이져')
        text = "2-%%C20 Hole(전선인입홀)"
        dim_leader(doc, x1 + 225, y1 + 252.5, x1 + 225 + 50, y1 + 252.5 + 50, text, direction="leftToright", distance=13)   # distance 13은 글자높이임       
        text = "%%C8"
        dim_leader(doc, x1 + 40, y1 + 252.5, x1 + 40 + 50, y1 + 252.5 + 50, text, direction="leftToright", distance=13)   # distance 13은 글자높이임       
        ...
        BasicXscale = 2813
        BasicYscale = 1715
        TargetXscale = 3800 + (CW - 1600)  + (CD - 1500)   # 5500은 CW 1600 크기의 도면전체 크기를 의미함
        TargetYscale = 1700 + (CD - 1500)                  # 3400은 CD 1500 크기의 도면전체 크기를 의미함
        if(TargetXscale/BasicXscale > TargetYscale/BasicYscale ):
            frame_scale = TargetXscale/BasicXscale
        else:
            frame_scale = TargetYscale/BasicYscale
    ...
    ###################################################
        ...
        for i in range(1, lastNum + 1):
            ...
            if i == 4:
                ...
                line(doc, x6, prev_y, curr_x, curr_y, layer="레이져")
                prev_x, prev_y = curr_x, curr_y
        ...
        insert_block(x5, y5, "Ceiling_foot_OP900")
        #절곡라인  (히든선 : 정방향)      
        line(doc, x8, y8, x3, y3, layer='hidden')     
        #front 장공
        sum = 0
        ...
        dim(doc, x4, y4, x4 - (MCW - 1215)/2 - 20, y4, 80, direction="up", option='reverse', localdimstyle="0.2 JKW")
        dim(doc, x7, y7, x7 + (MCW - 1215)/2 + 20, y7, 80, direction="up", option='reverse', localdimstyle="0.2 JKW")
    ...
    ###################################################
        ...
        textstr = f"Mat.Spec : SPCC 2.3t"    
        draw_Text(doc, x1 , y1 - 60 , 30, str(textstr), layer='0')
        textstr = f"Size : 56 x {mcsizex2}mm"    
        draw_Text(doc, x1 , y1 - 120 , 30, str(textstr), layer='0')
        textstr = f"Quantity : {su} EA"    
        draw_Text(doc, x1 , y1 - 180 , 30, str(textstr), layer='0')
    ...
    ###################################################
        ...
        insert_block(x1 + (MCD - 349)/3, y1 + 90.6, "Ceiling_Bracket_horizontal_hole4_laser")
        insert_block(x1 + (MCD - 349)*2/3, y1 + 90.6, "Ceiling_Bracket_horizontal_hole4_laser")
        ...
        dimcontinue(doc, x4 + (MCD - 349)/3 - 30, y4)
        dimcontinue(doc, x4 + (MCD - 349)/3 + 30, y4)
        dimcontinue(doc, x4 + (MCD - 349)*2/3 - 30, y4)
        dimcontinue(doc, x4 + (MCD - 349)*2/3 + 30, y4)
        dimcontinue(doc, x3 - 30, y4)
        dimcontinue(doc, x3, y4)
        # 하부 전체치수
        ...
        textstr = f"Mat.Spec : SPCC 1.6T"
        draw_Text(doc, x1 , y1 - 60 , 30, str(textstr), layer='0')
        textstr = f"Size : 181.2 x {mcsizex3}mm"
        draw_Text(doc, x1 , y1 - 120 , 30, str(textstr), layer='0')
        textstr = f"Quantity : {su} EA"
        draw_Text(doc, x1 , y1 - 180 , 30, str(textstr), layer='0')
    ...
    ###################################################
        ...
        textstr = f"Mat.Spec : SPCC 1.6T"    
        draw_Text(doc, x1 , y1 - 60 , 30, str(textstr), layer='0')    
        textstr = f"Size : 181.2 x {(MCW/3 - 1)}mm"    
        draw_Text(doc, x1 , y1 - 120 , 30, str(textstr), layer='0')        
        textstr = f"Quantity : {su*3} EA"    
        draw_Text(doc, x1 , y1 - 180 , 30, str(textstr), layer='0')    
...
def main():
    ...
    global frontPanel, rearPanel, sidePanel, slotposition , AS_raw, EE_raw, ELYpos
