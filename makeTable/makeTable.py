...
def main():   
    ...
    for file_path in xlsx_files:
        ...
        hole=calculate_holeArray(15, 100, height)
        hole.pop()
        gap = 0
        ...
        for index, g in enumerate(hole):
            ...
            if index == 0 :
                d(doc, startx, starty+77, startx + g, starty+57.75, 50, direction="up", option="reverse")
            else:
        ...
        if program:         
            ...
            # 기본 상판보다 작게 만드는 원리임
            midplate_width = length - 6
            midplate_height = width - 6
