...
def MainCeiling():   
    ...
    if program:
        ...
        x2 = abs_x + MCW
        y2 = abs_y + MCD
        rectangle(doc, x1, y1, x2, y1 + (MCD - 1000), layer='0')    
        rectangle(doc, x1, y1 + (MCD - 1000), x2, y2, layer='0')    
        ...
        for i in range(num_holes):
            ...
            if i == 0:
                dim(doc, x2, y1,  x1 + 25 + rightholex[i], y1 + 25 + vertical_holey[i], 300, direction="left",  localdimstyle="0.2 JKW")    
            else:
        ...
        insert_block(x1 + MCW/3 + 30, y2 - 1000, "Ceiling_Bracket_horizontal_hole2")
        insert_block(x1 + MCW*2/3 - 30, y2 - 1000, "Ceiling_Bracket_horizontal_hole2")
        ...
        insert_block(x1 + MCW/3 + 30, y2 - 362.5, "Ceiling_Bracket_horizontal_hole2")
        insert_block(x1 + MCW*2/3 - 30, y2 - 362.5, "Ceiling_Bracket_horizontal_hole2")
        ...
        #우측 치수선
        dim(doc, x2, y2, x2, y1, 210, direction="right", localdimstyle="0.2 JKW")#전체
        #내부 치수선
    ...
    if program:    
        ...
        line(doc, x, y2 - 1000, x2, y2 - 1000, layer="레이져")
...
def main():
    ...
    global frontPanel, rearPanel, sidePanel, slotposition , AS_raw, EE_raw
