...
def calculate_lc_position_008_A2_LEFT(inputCW, inputCD):
    # Calculate Y-coordinates for top and bottom holes
...
def calculate_lc_position_008_A2_RIGHT(inputCW, inputCD):
    # Calculate Y-coordinates for top and bottom holes
    Topholey = (int)(inputCD - 13)
    Bottomy = 13
...
def calculate_lc_position_008_A2_TOP(inputCW, inputCD):
    # Calculate Y-coordinates for top and bottom holes
    Leftx = 13 
...
def calculate_lc_position_008_A2_BOTTOM(inputCW, inputCD):
    # Calculate Y-coordinates for top and bottom holes
    Leftx = 13 
    Rightx = (int)(inputCW - 13)
...
def calculate_lc_position_008_A2_ASSY_vertical  (inputCW, inputCD):
    ...
    y1 = firstYgap
    y2 = (int)(inputCD/2-firstYgap*2)/3 + firstYgap
    y3 = (int)(inputCD/2-firstYgap*2)*2/3 + firstYgap
...
def lc008_A():   
    ...
    if program:    
        ...
        lc_positions = calculate_lc_position_008_A2_LEFT(inputCW, inputCD)
    ...
    # }        
        ...
        lc_positions = calculate_lc_position_008_A2_RIGHT(inputCW, inputCD)            
    ...
    # }        
        ...
        lc_positions = calculate_lc_position_008_A2_TOP(inputCW, inputCD)
        ...
        lc_positions = calculate_lc_position_008_A2_BOTTOM(inputCW, inputCD)
    ...
    # }        
        ...
        for i, x in enumerate(Bottomx):       
            ...
            print(f"x{i} : {x}")
            if i == 0:
                dim(doc, x1+x , y1 , x1, y1+10 , 100,  direction="down", option='reverse')    
            else:
                dimcontinue(doc , x1 + x, y1+10 )
        ...
        # lc008_A_CD_holes = calculate_lc_position_008_A2_FRAME_CD(inputCW, inputCD)
        
        
        # for i, y_coord in enumerate(lc008_A_CD_holes):  
        #     xval =  y_coord 
        #     y = y1 + 10
        #     # print(f"CD 방향 중판 홀의 i변수 {i}  , x 좌표: {xval}")        
        #     # circle_cross(doc, x12 + xval , y , 10, layer='레이져')
        #     if i>0 :
        #         dimcontinue(doc,  x1 + xval , y )
        #     else:
        #         dim(doc, x1+13.2 , y1+10,  x1  , y1 , 200, direction="down", option='reverse') 
        #     if i==3:
        #         baseX, baseY = x1 + xval , y

        # dimcontinue(doc,  x2 , y2 )
        
        # dim_leader_line(doc, x8 + (CD-156)/2, y1+10 , x8 + (CD-156)/2 + 50 ,y1+15- 30, f"{len(lc008_A_CD_holes)} -%%C9 Hole")       
        # dim(doc, x8 + (CD-156)/2, y1+10 , x8 + (CD-156)/2 , y1, 100, direction="left")        
        ...
        # dim(doc, x8 , y8 , x7 , y7, 240, direction="up")    
        # for i, y_coord in enumerate(sorted_y_coords):  
        #     xval =  y_coord - 25     
        #     # print(f"CD방향 홀의 i변수 {i}  , y 좌표: {xval}")        
        #     circle_cross(doc, x8 + xval , y11 - 8 , 11, layer='레이져')
        #     if i>0 :
        #         dimcontinue(doc,  x8 + xval , y8 - 15 )
        #     else:
        #         dim(doc,  x8+15, y8 - 15 , x8 , y8 , 70, direction="up", option="reverse") 
        #     if i==1:
        #         baseX, baseY = x8 + xval , y8 - 15

        # dimcontinue(doc,  x7 , y7 )

        # # 11파이 지시선
        # dim_leader_line(doc, baseX, baseY , baseX + 100 ,baseY + 50, f"{len(sorted_y_coords)} -%%C11 Hole (M8 Pop Nut)")       
        # dim(doc,   baseX, baseY , baseX  , y8, 100, direction="left")

        # # 하부 단공치수, 배열된 것을 구현함 결합되는 홀임
        # lc008_vertical_holes = calculate_lc_position_008_A2_ASSY_horizontal
        
        # for i, y_coord in enumerate(lc008_vertical_holes):  
        #     xval =  y_coord 
        #     y = y1 + 10
        #     # print(f"CD 방향 중판 홀의 i변수 {i}  , x 좌표: {xval}")        
        #     circle_cross(doc, x12 + xval , y , 10, layer='레이져')
        ...
        #         dim(doc, x1+13.2 , y1+10,  x1  , y1 , 200, direction="down", option='reverse') 
        #     if i==3:
        #         baseX, baseY = x12 + xval , y

        # dimcontinue(doc,  x2 , y2 )

        # # 9파이 지시선
        # dim_leader_line(doc, baseX, baseY , baseX + 50 ,baseY - 30, f"{len(lc008_vertical_holes)} -%%C9 Hole")       
        ...
        #     circle_cross(doc, x12 + xval , y , 15, layer='레이져')
        #     if i>0 :
        #         dimcontinue(doc,  x12 + xval , y )
        #     else:
        #         dim(doc, x12+225, y,  x12  , y12 , 150, direction="down", option='reverse') 
        #     if i==1:
        #         baseX, baseY = x12 + xval , y
    ...
    if program:
        ...
        lc_positions = calculate_lc_position_008_A2_FRAME_CW(inputCW, inputCD)
    ...
    # }        
        ...
        #     circle_cross(doc, x8 + xval , y , 11, layer='레이져')        
        #     if i== 0:
        #         dim(doc,  x8 + xval  , y  , x8   , y8 , 100, direction="up", option="reverse") 
        #     else:
        #         dimcontinue(doc,  x8 + xval , y )        
            
        #     if i==0:
        #         baseX, baseY = x8 + xval , y
        ...
        #     y = y8 + 21 - vcut
        #     # print(f" 중판 clip 홀의 i변수 {i}  , x 좌표: {xval}")        
        #     circle_cross(doc, x8 + xval , y , 15, layer='레이져')
        #     if i>0 :
        #         dimcontinue(doc,  x8 + xval , y )
        #     else:
        #         dim(doc, x8+233, y,  x8  , y8 , 120, direction="down", option='reverse') 
        #     if i==1:
        #         baseX, baseY = x8 + xval , y
